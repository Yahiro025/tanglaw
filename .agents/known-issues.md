...
- `[2026-06-01] DESIGN_ISSUE: All MetaBuff agents hardcoded deepseek/deepseek-v4-flash. Upgraded primary model to deepseek/deepseek-v4-pro across all 8 agents (metabuff, metabuff-mega, metabuff-validator, metabuff-arch, metabuff-reasoner, metabuff-security, metabuff-testgen, metabuff-regex-guard). Fallback to v4-flash is implicit when v4-pro is unavailable in the environment. Updated knowledge.md and known-issues.md to reflect the change.`
