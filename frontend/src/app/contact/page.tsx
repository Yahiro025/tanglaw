        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <section className="rounded-[2rem] border border-white/10 bg-[color:var(--theme-surface)]/90 p-8 shadow-2xl shadow-black/20 backdrop-blur-sm">
            <div className="space-y-6">
              ...
              <h2 className="text-2xl font-black text-[color:var(--theme-typography-main)]">Academic Sponsorship</h2>
          ...
          <main className="rounded-[2rem] border border-white/10 bg-[color:var(--theme-surface)]/90 p-8 shadow-2xl shadow-black/20 backdrop-blur-sm">
            ...
            {submitted && (
              <div className="mb-6 rounded-3xl border border-primary/40 bg-[color:var(--theme-surface)]/90 p-4 text-sm text-[color:var(--theme-text-body)] shadow-inner">
